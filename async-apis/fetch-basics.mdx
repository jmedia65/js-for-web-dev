...
console.log(newUser); // { id: 1, name: "Jane Doe", email: "jane@example.com" }
```
...
You can now fetch data from your FastAPI backend. Next, let's learn how to handle loading states so users know when data is being fetched.
