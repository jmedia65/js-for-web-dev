...
|---|---|---|
| Variables | `name = "Jane"` | `const name = "Jane";` |
...
```bash
node hello.js
# Welcome to JavaScript, Jane!
```

<Tip>
Use the browser console to test quick ideas and one-liners. Use Node.js for anything you want to save or build on. You'll set up Node.js in the Getting Started section.
</Tip>
