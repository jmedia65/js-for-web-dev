...
const noResult = logMessage("Hello");
...
This is where JavaScript differs from Python in a meaningful way. Functions are values — you can pass them to other functions, store them in arrays, return them from functions.
